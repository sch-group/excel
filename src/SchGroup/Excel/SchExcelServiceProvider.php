...
use SchGroup\Excel\Readers\Html;
use SchGroup\Excel\Classes\Cache;
use SchGroup\Excel\Classes\PHPExcel;
use Illuminate\Support\ServiceProvider;
use Illuminate\Support\Collection;
use Illuminate\Support\Facades\Response;
use SchGroup\Excel\Parsers\CssParser;
use SchGroup\Excel\Parsers\ViewParser;
use SchGroup\Excel\Classes\FormatIdentifier;
use SchGroup\Excel\Readers\LaravelExcelReader;
use SchGroup\Excel\Writers\LaravelExcelWriter;
...
class SchExcelServiceProvider extends ServiceProvider {
    ...
    public function boot()
    {
        if ($this->app instanceof LumenApplication) {
            ...
            $this->publishes([
                __DIR__ . '/../../config/sch_excel.php' => config_path('sch_excel.php'),
            ]);
        }

        $this->mergeConfigFrom(
            __DIR__ . '/../../config/sch_excel.php', 'excel'
        );
